...
public class EmployeeLeaveListActivity extends AppCompatActivity {
    ...
    private void employeeLeaveList() {
        ...
        Call<EmployeeLeaveListResponse> userCall = api.employeeLeaveList("{\"logged_session_data\": "+ AppConstant.getLogged_session_data(context)+"}");
    ...
    public class MyListAdapter extends RecyclerView.Adapter<MyListAdapter.ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View listItem= layoutInflater.inflate(R.layout.item_employee_leave_list, parent, false);
        ...
        public  class ViewHolder extends RecyclerView.ViewHolder {
            public TextView tvEmployeeName,tvLeaveType,tvFormDate,tvToDate,tvNumberOfDays,tvRemainLeave,tvStatus;
